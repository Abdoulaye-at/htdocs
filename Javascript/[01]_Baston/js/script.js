...
//Il nous faut, l'image du personne, son nom et des dialogues défilants.

//On commence par créer les elements du premiers personnage
function init(infos){

   //récuperation du contexte pour l'implémentation des élements
  ...
  // Implementation des éléments à intégrer :
    // Gestion de l'image
