...
// Je relie ma page de connexion 
require_once 'connect.php';

$order = '';

// Gestion de l'ordre l'affichage
...
if(!empty($_POST)){
	...
	if(!isset($errors)){
		...
		// J'insert l'utilisateur dans ma base de données
...
<html>
	...
	<body>
		<div class="container">
			...
			<!-- Affichage des utilisateurs sous forme de table html -->
			<div class="row">
				<div class="col-md-7">
					<table class="table">
						<thead>
